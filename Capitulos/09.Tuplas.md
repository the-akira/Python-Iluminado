...
Ao utilizarmos uma Named Tuple, nosso código se torna mais legível, porém é importando que devemos importá-la da biblioteca [collections](https://docs.python.org/3/library/collections.html):
