...
- Um nome de função para identificar exclusivamente a função. A nomenclatura de funções segue as mesmas regras de escrita de identificadores em Python.
...
Por exemplo, vamos definir uma função capaz de converter uma temperatura em **Celsius** para **Fahrenheit**.
...
def fahr_to_celsius(temp):
	...
	em Celsius e converter para Fahrenheit
	"""
	return ((temp - 32) * (5/9))
```
